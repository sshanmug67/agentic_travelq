...
//
// Changes (v2 — Compact):
//   - Smaller header (text-3xl, less margin)
//   - Tighter section spacing (mb-4 instead of mb-6)
//   - Section headings: text-lg instead of text-2xl
//   - Restaurants & Activities: grid-cols-2 layout instead of stacked
//   - Budget receipt: tighter padding
//   - Action buttons: smaller text
//   - Overall ~35% vertical space savings
